...
with st.tab1:
    ...
    if uploaded_file:
        ...
        if st.session_state.tab1_imported_file_name != uploaded_file.name:
        ...
        try:
            ...
            st.session_state.tab1_imported_file_name = uploaded_file.name
    ...
    if df_org_data is not None:
        ...
        if st.session_state.tab1_generation_done == True:
            df_output_data = st.session_state.tab1_df_output_data
        ...
        if st.button("Produkttexte generieren"):
            ...
            st.session_state.tab1_df_output_data = df_output_data
...
with st.tab1:
    ...
    with st.expander("Information"):
                ...
                st.markdown("""
                    <p>
                    !! Dieser Text muss überarbeitet werden.        
